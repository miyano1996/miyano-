<template>
  <div class="shopcar-body">
    <h1 style="text-align:center; border-bottom:1px solid #efefef ;padding:10px">购物车</h1>
    ...
    >
      ...
      <el-table-column align="center" prop="goodId.price" label="价格" width="250"></el-table-column>
      ...
      <el-table-column align="center" fixed="right" label="操作" width="200">
        ...
        <template slot-scope="scope">
          <el-button @click="userpay(scope.row._id)" type="primary" size="small">免密支付</el-button>
...
export default {
  ...
  created() {
    this.getCarOrders(localStorage.userId);
  },
  methods: {
    ...mapActions(["getCarOrders", "delCarOrder", "pay"]),
    async delit(id) {
