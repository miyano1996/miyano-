    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: "notListedGoods",
            component: () => import("../components/goods/notListedGoods.vue"),
          },
          {
            path: "goodsDetails.vue",
            component: () => import("../components/goods/goodsDetails.vue"),
          },
          {
            path: "addGood",
          ...
          {
            path: "goodOrderList",
            component: () => import("../components/orders/goodOrderList.vue"),
          },
        ],
      },
    ],
